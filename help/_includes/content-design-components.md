...
1. Vouw de sectie **[!UICONTROL Contents]** uit en voeg zoveel inhoudscomponenten toe als u nodig hebt in een of meer structuurcomponenten.
   ...
   ![ sleep een inhoudselement op het canvas en pas de montages aan](../assets/content-design-shared/content-design-add-content.png){width="800" zoomable="yes"}
&lt;!--
verwijzing naar de inhoudselementen wanneer wij een volledige verwijzing voor elk hebben.
