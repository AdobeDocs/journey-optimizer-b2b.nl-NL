...
1. Klik op **[!UICONTROL Edit web experience]** in het rechterdeelvenster terwijl het tabblad _[!UICONTROL Content]_wordt weergegeven op de pagina met webervaringsdetails.
...
* **[!UICONTROL Image]** - Gebruik deze component om een afbeeldingsbestand in te voegen in de pagina. U kunt de opmaakkenmerken, zoals de breedte en hoogte, aanpassen aan de hand van de eigenschappen in het rechterdeelvenster. Zie ](./content-components.md#image) Beeld 0} in _componenten van de Inhoud_ voor meer informatie.[
* **[!UICONTROL Heading]** - Gebruik deze component om kopklassetekst in te voegen. U kunt de opmaakkenmerken, zoals de tekstkleur, stijl, lettertype en grootte, aanpassen met de eigenschappen in het rechterdeelvenster. Zie ](./content-components.md#text) Tekst van 0} {in _componenten van de Inhoud_ voor meer informatie.[
* **[!UICONTROL Paragraph]** - Gebruik deze component om een standaardtekstelement in te voegen. U kunt de opmaakkenmerken, zoals de tekstkleur, stijl, lettertype en grootte, aanpassen met de eigenschappen in het rechterdeelvenster. Zie ](./content-components.md#text) Tekst van 0} {in _componenten van de Inhoud_ voor meer informatie.[
...
1. Klik op **[!UICONTROL Add modification]** in het rechterdeelvenster terwijl het tabblad _[!UICONTROL Content]_wordt weergegeven op de pagina met webervaringsdetails.
...
1. Voer de kiezer in het veld **[!UICONTROL CSS Element Selector]** in.
   ...
   **de selecteurs van het Voorbeeld:**

   | Kiezer | Doelen |
   | -------- | ------- |
   | `#hero-banner` | Element met id `hero-banner` |
   | `.cta-button` | Alle elementen met klasse `cta-button` |
