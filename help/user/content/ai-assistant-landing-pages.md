---
title: AI Assistant voor Landing Page Content
description: Inhoud van bestemmingspagina genereren met AI Assistant - hiermee maakt u paginatekst en -afbeeldingen met uw referentie-elementen en kunt u de rol van de inkoopgroep activeren in Journey Optimizer B2B edition.
...
# AI Assistant voor Landing Page Content {#generative-full-content}

AI Assistant voor het landen van pagina-inhoud in [!DNL Adobe Journey Optimizer B2B Edition] gebruikt Adobe-functionaliteit voor het genereren van inhoud op basis van AI en maakt een revolutie in de manier waarop marketers professionele en merkbestendige landingspagina-inhoud maken. Met geavanceerde generatieve AI-modellen en een goed begrip van de richtlijnen voor merken genereert AI Assistant automatisch persoonlijke, aantrekkelijke en effectieve inhoud. Hierbij wordt uw marketingdoelstelling gebruikt en de inhoud geoptimaliseerd voor stijlen, lay-outs, tinten en meer met een merknaam. Met AI Assistant maakt u het maken en uitvoeren van campagnes en programma&#39;s intuïtiever, eenvoudiger en probleemloos. Door deze mogelijkheid toe te voegen aan uw workflows kunt u tijd besparen, de efficiëntie verbeteren en betere resultaten behalen.

U kunt volledige inhoud voor uw openingspagina&#39;s, met inbegrip van zowel tekst als beelden produceren. Deze robuuste functionaliteit helpt u aansprekende, on-brand inhoud te creëren die met uw publiek verbindt.
...
* Gebruik een merkspecifieke of aangepaste sjabloon voor het genereren van inhoud voor een volledige landingspagina. U wordt aangeraden paginasjablonen met maximaal 8-10 afbeeldingen te plaatsen.
...
U kunt volledige inhoud genereren voor een openingspagina of voor geselecteerde componenten op de pagina. Wanneer u de AI Assistant-gereedschappen gebruikt om de inhoud te genereren die u nodig hebt, geeft u de invoer op, inclusief vragen en inhoud ter referentie, en de instellingen voor tekst en afbeeldingen.
...
* **[!UICONTROL Generative model]**: kies uit het gebruiksklare Adobe-model, het partnermodel voor gespecialiseerde mogelijkheden, of gevormde aangepaste modellen die op uw merkmiddelen worden opgeleid. Voor meer informatie over generatieve modellen, zie _[Generatieve AI modellen voor merkgroepering](generative-ai-models.md)_.
...
Ga als volgt te werk om AI Assistant te gebruiken om de tekstinhoud voor een bestaande landingspagina te verfijnen of te verbeteren:
...
Ga als volgt te werk om AI Assistant te gebruiken om de afbeeldingsinhoud voor een bestaande landingspagina te verfijnen of te verbeteren:
...
## Voorvertoning en verfijning van inhoud {#refine-finalize}
...
Klik op de optie **[!UICONTROL Refine]** voor aanvullende aanpassingsfuncties voor het landen van pagina- en tekstvariaties:
