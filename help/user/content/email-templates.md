...
* Klik op de aanbiedingspagina van _[!UICONTROL Email Templates]_op de ovaal (...) naast de sjabloon en kies **[!UICONTROL Duplicate]**.
...
* Klik op de aanbiedingspagina van _[!UICONTROL Email Templates]_op de ovaal (...) naast de sjabloon en kies **[!UICONTROL Delete]**.
