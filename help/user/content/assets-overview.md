---
title: Assets
description: Afbeeldingselementen beheren vanuit Journey Optimizer B2B edition en AEM Assets voor e-mails, sjablonen en fragmenten.
...
In [!DNL Adobe Journey Optimizer B2B Edition] zijn elementen doorgaans de afbeeldingen die worden gebruikt bij het ontwerpen van inhoud ter ondersteuning van reizen naar accounts. U kunt deze afbeeldingen gebruiken in uw e-mails, e-mailsjablonen en fragmenten vanuit de elementenkiezer of via een eenvoudige interface voor slepen en neerzetten in de visuele ontwerpruimte.

[!DNL Journey Optimizer B2B Edition] biedt ontwerpers en marketers toegang tot twee typen elementenbibliotheken: een interne [!DNL Journey Optimizer B2B Edition] opslagplaats voor elementen en [!DNL Adobe Experience Manager Assets as a Cloud Service] . U kunt alleen de ingebouwde opslagplaats gebruiken of beide bibliotheektypen tegelijk gebruiken (op basis van de [!DNL Experience Manager Assets] -licentie die u hebt).

## Beheer van bedrijfsmiddelen

Als u beschikt over [!DNL Adobe Experience Manager as a Cloud Services] en deze is geconfigureerd als bron van middelen in [!DNL Journey Optimizer B2B Edition] , hebt u toegang tot beide typen opslagplaatsen wanneer uw gebruikersaccount de vereiste machtigingen heeft. Deze opslagruimten zijn gescheiden en niet gesynchroniseerd. U kunt afbeeldingen uit beide bronnen gebruiken.

### Interne activa

De interne gegevensopslagruimte wordt standaard bij elk [!DNL Journey Optimizer B2B Edition] -abonnement geleverd. Dit betekent dat u toegang hebt tot alle afbeeldingselementen die zijn opgeslagen in het gekoppelde [!DNL Adobe Marketo Engage] assetbestandssysteem. U kunt deze gegevensopslagruimte gebruiken als uw lokale bibliotheek met middelen, waaronder functies voor het uploaden en downloaden van middelen. U kunt deze middelen ook gebruiken binnen uw reisinhoud.

U kunt [ deze activa uitgeven gebruikend Adobe Express ](./image-edit-adobe-express.md), en hen bewegen in omslagen om hen voor gebruik over uw e-mail, malplaatjes, en fragmenten te organiseren.
...
Gebruik elementen bij het ontwerpen van uw e-mails, e-mailsjablonen en visuele fragmenten. De visuele inhoudeditor biedt toegang tot de afbeeldingen in uw verbonden opslagruimten voor elementen. Als u ook een abonnement hebt op Experience Manager Assets as a Cloud Service, kunt u afbeeldingselementen kiezen uit beide bronnen. U kunt ook een afbeeldingselement uploaden, waardoor het in de interne opslagplaats voor elementen wordt geplaatst.
...
* **_de componententoolbar van het Beeld_** - wanneer u een beeldcomponent hebt die in het canvas wordt geselecteerd, verleent de toolbar gemakkelijke toegang om een bron te kiezen en het beelddossier te selecteren.
...
>[!TAB  Uitgezochte Activa ]

Klik op **[!UICONTROL Select Asset]** om de elementenkiezer te openen, waar u een afbeelding kunt kiezen in de Journey Optimizer B2B edition-gegevensopslagruimte.

![ Uitgezocht een beeldactiva ](./assets/content-assets-internal-image-selected.png){width="700" zoomable="yes"}
...
Voor meer gedetailleerde informatie over het gebruiken van interne beeldactiva, zie [ activa van het Gebruik in uw inhoud ](./internal-image-assets.md#use-assets-in-your-content).
...
![ selecteer uw eigen beelddossier om als activa ](./assets/content-assets-image-import-file-selected.png){width="450" zoomable="yes"} in te voeren

Klik op **[!UICONTROL Import]** nadat u het bestand hebt gesleept en neergezet of vanuit het bestandssysteem hebt geselecteerd. Het geïmporteerde element wordt opgeslagen in de [!DNL Journey Optimizer B2B Edition] Asset-gegevensopslagruimte.
