---
title: Werken met Assets voor interne afbeeldingen
description: 'Blader naar, beheer en gebruik Journey Optimizer B2B edition-middelen: organiseer mappen, bewerk afbeeldingen en maak inhoud voor reizen naar accounts.'
...
Van de _Assets_ lijstpagina, kunt u beeldactiva aan de de activabewaarplaats van B2B edition van Journey Optimizer toevoegen.
...
1. Selecteer de doelmap om de elementen op te slaan.
...
Gebruik een van de volgende methoden om een element te verwijderen:
...
Gebruik een van de volgende methoden om een element dat zich bevindt in de _[!UICONTROL Journey Optimizer B2B Edition]_-opslagplaats voor elementen te vervangen:
