...
![ heb toegang tot het Meer menu voor het merk ](./assets/brands-library-card-more-menu.png){width="440"}
...
![ markering van het Standaard merk ](./assets/brands-default-flag.png){width="200"}
...
![ wijs de standaardmerkidentiteit ](./assets/brands-set-default.png){width="350"} aan
...
1. Blader door de verschillende tabbladen om desgewenst gedetailleerdere informatie aan te passen en te definiëren.
   ...
   * [[!UICONTROL Visual content]](#visual-content)
   ...
   Van het _Meer menu_ ( ![ Meer menupictogram ](../../assets/do-not-localize/icon-more-menu.svg)) voor elke lusje of categorie, kunt u documenten toevoegen om relevante merkinformatie automatisch te halen. U kunt ook de bestaande inhoud wissen.
...
1. Controleer op elk tabblad Details de categorieën en verbeter het merk door uw definities toe te voegen, te verwijderen en te wijzigen.
   ...
   * **Verandering een richtlijn of een uitsluiting**.
     ...
     ![ Verandering een richtlijn ](./assets/brands-guideline-update.png){width="600" zoomable="yes"}
...
Gepubliceerde merken zijn toegankelijk van de **[!UICONTROL Brand]** optie in de AI [ merkgroeperingsscore ](./content-evaluation.md#brand-alignment-score) en [ hulpmiddelen van de inhoudsgeneratie ](../ai-assistant/generative-ai-content.md).
...
1. Geef in de categorie **[!UICONTROL Guiding principles]** uitleg over de kernrichting en filosofie van uw merk:
   ...
   * Om een nieuwe kernwaarde te bepalen, klik _toevoegen_ ( ![ voeg pictogram ](../assets/do-not-localize/icon-add-components.svg)) pictogram op het recht toe en voltooi de details:
     ...
     ![ Ongeveer het merk - Geleidende principes - voeg kernwaarde ](./assets/brands-about-guiding-principles-add-core-values.png){width="500" zoomable="yes"} toe
   ...
   * Om een kernwaarde te veranderen of te schrappen, _te klikken geeft_ uit ( ![ geef pictogram ](../assets/do-not-localize/icon-edit.svg)) pictogram uit om een waarde van het kernmerk bij te werken of te schrappen.
     ...
     ![ Ongeveer het merk - Geleidende principes - geef kernwaarde uit ](./assets/brands-about-guiding-principles-edit-core-values.png){width="500" zoomable="yes"}
