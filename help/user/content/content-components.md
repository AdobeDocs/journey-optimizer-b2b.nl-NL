...
| ![&#x200B; pictogram van de Vorm &#x200B;](../../assets/do-not-localize/icon-content-component-form.svg) | [&#x200B; Vorm &#x200B;](#form) | **_Beschikbaar voor het landen slechts pagina&#39;s._** Voeg deze component toe aan uw ontwerp om een gemaakt formulier in te voegen. |
...
![&#128279;](../assets/do-not-localize/toolbar-content.png){width="450"} de componententoolbar van 0&rbrace; Inhoud
...
<table>
    <tr>
        ...
        <th style="width: 20%;">Componenten</th>
    </tr>
    <tr>
...
<table>
    <tr>
        ...
        <th style="width: 60%;">Gebruik</th>
        <th style="width: 25%;">Componenten</th>
    </tr>
    <tr>
...
| ---- | ---- | ----- |
| ![&#x200B; voeg verpersoonlijking &#x200B;](../assets/do-not-localize/toolbar-button-add-personalization.png){width="40"} toe | Aanpassing toevoegen | Use the personalization editor to insert personalization tokens in the component content. [Meer informatie &#x200B;](./email-authoring.md#personalize-content) |
| ![Show the source code](../assets/do-not-localize/toolbar-button-show-source-code.png){width="40"} | Show the source code | De HTML-broncode voor de component weergeven in een alleen-lezen pop-up. <br/>![Show HTML code](./assets/content-components-show-source-code.png){width="200"} |
...
Aangezien u met uw ontwerp werkt, kunt u [&#128279;](#remove-a-content-component) of [&#x200B; ook verwijderen &#x200B;](#duplicate-a-content-component) een component.
...
* _[!UICONTROL Show only on mobile devices]_- Kies deze instelling wanneer u de component wilt weergeven op mobiele apparaten, zoals telefoons en tablets, en sluit deze uit voor bureaubladapparaten.

![&#x200B; de opties van de vertoning voor inhoudscomponent &#x200B;](./assets/content-components-display-options.png){width="400" zoomable="yes"}

### Container

Gebruik een container om specifieke opmaak toe te passen op een groep inhoudcomponenten. Voeg een [!UICONTROL Container] -component toe en voeg vervolgens andere inhoudcomponenten toe. Deze component is vergelijkbaar met de manier waarop u een `div` -element in HTML kunt gebruiken. U kunt een afzonderlijke stijl op de container toepassen die verschilt van de stijl die is toegepast op de inhoudcomponenten die de container bevat.

Voeg bijvoorbeeld een _[!UICONTROL Container]_-component toe en voeg vervolgens een&#x200B;_[!UICONTROL Button]_ -component toe in die container. U kunt een specifieke gebiedsindeling voor de container gebruiken en de knop en de achtergrond naar wens opmaken.

![&#x200B; de componentenstijlen van de inhoud van de Container &#x200B;](./assets/content-components-container.png){width="600" zoomable="yes"}
...
Gebruik de component [!UICONTROL Button] om een of meer klikbare knoppen in uw inhoud in te voegen. Gebruik knoppen om paginaviewers of e-mailontvangers om te leiden naar ondersteunende inhoud (gepubliceerde landingspagina of een externe koppeling).

#### Knoptekst toevoegen

Wanneer de knopcomponent op het canvas wordt weergegeven, bevat de werkbalk opties voor tekstopmaak, personalisatie en voorwaardelijke varianten. Zie # voor meer informatie over de opties op de editor-werkbalk.
...
1. Stel de **[!UICONTROL Type]** voor de koppeling in:
   ...
   * **[!UICONTROL External link]** - Kies dit type als u een standaard-URL als doel voor de koppeling wilt gebruiken.
     ...
     Voer in **[!UICONTROL Url]** de URL in voor het doel van de koppeling. Klik _personaliseren_ ( ![&#x200B; aanpassen pictogram &#x200B;](../assets/do-not-localize/icon-personalize.svg)) pictogram om een verpersoonlijkingstoken als parameter in URL te gebruiken.
...
Gebruik de component Text om een tekstblok in te voegen in uw inhoud. Wanneer de tekstcomponent is geselecteerd op het canvas, voert u de tekst in en gebruikt u de werkbalkopties om inline opmaak en opties toe te voegen, waaronder personalisatietokens en voorwaardelijke varianten. <!-- For detailed information about crafting text, including inline styling and options, in the design space, see [Text authoring](#). -->
...
Voeg component van de a _Scheidingsverdeler_ toe om een lineaire scheiding tussen secties van uw inhoud op te nemen.
...
Gebruik de HTML-component om onderdelen van uw bestaande HTML toe te voegen. Met deze component kunt u op eenvoudige wijze modulaire HTML-elementen maken die uw externe inhoud opnieuw gebruiken.

1. Selecteer de component op het canvas en klik _tonen het broncode_ pictogram in de toolbar.

   [De code-editor openen om de HTML toe te voegen](./assets/content-components-html-show-code.png){width="450"}

1. Plak de HTML in het tekstvak en klik op **[!UICONTROL Save]** .

   [&#x200B; geef de dialoog van de HTML &#x200B;](./assets/content-components-html-edit-dialog.png){width="600" zoomable="yes"} uit

   Als de HTML geldig is, wordt het element op het canvas weergegeven. Als het een element is dat aan een van de andere inhoudscomponenten is toegewezen, kunt u de instellingen en stijlen in het rechterdeelvenster wijzigen op basis van het type component. Als dit niet het geval is, blijft het een HTML-component.

Voor een HTML-component kunt u de volgende stijlen instellen voor de volledige HTML-component in het rechterdeelvenster:
...
Gebruik de component [!UICONTROL Image] om een afbeeldingselement in uw inhoud in te voegen. Wanneer de _component van het Beeld_ in het canvas wordt geselecteerd, kunt u het getoonde dossier van de beeldactiva toevoegen of veranderen.
...
Kies het [&#x200B; type van middelbron &#x200B;](./assets-overview.md) en selecteer een beelddossier:

* **[!UICONTROL Marketo Engage Assets]** - Kies dit type om door een afbeeldingselement te bladeren in de Journey Optimizer B2B Edition-bibliotheek of in de verbonden Market Engage-instantie.
...
[!BADGE &#x200B; Beta &#x200B;]{type=Informative url="/help/user/content/forms.md" tooltip="Beta-functie"}
