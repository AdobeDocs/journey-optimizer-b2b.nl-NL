...
](../assets/do-not-localize/toolbar-content.png){width="450"} de componententoolbar van 0} Inhoud![
...
Voeg bijvoorbeeld een _[!UICONTROL Container]_-component toe en voeg vervolgens een_[!UICONTROL Button]_ -component toe in die container. U kunt een specifieke gebiedsindeling voor de container gebruiken en de knop en de achtergrond naar wens opmaken.
