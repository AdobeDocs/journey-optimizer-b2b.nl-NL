...
Nadat u [ een het landen pagina ](./landing-pages.md#create-a-landing-page) creeert, gebruik de visuele ontwerper aan auteur de structuur en inhoudscomponenten in uw pagina.
...
Vanuit het menu _[!UICONTROL More ...]_boven aan de visuele ontwerper kunt u de volgende handelingen uitvoeren:

![ klik Meer om tot malplaatjeacties ](./assets/landing-page-designer-more-menu.png){width="500"} toegang te hebben

* **[!UICONTROL Reset landing page]** - Klik op deze optie om het canvas van de visuele ontwerper op een lege site te wissen en opnieuw het bouwen van de pagina-inhoud te starten.
