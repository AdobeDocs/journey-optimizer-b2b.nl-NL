...
1. Klik op **[!UICONTROL Close]** om terug te keren naar de _[!UICONTROL Create a theme]_&#x200B;pagina en vervolgens op **[!UICONTROL Cancel]**&#x200B;om terug te keren naar de ontwerppagina.
   ...
   U kunt **[!UICONTROL Design from scratch]** dan kiezen om de visuele ontwerpruimte te openen en [&#x200B; het thema &#x200B;](#use-email-theme) voor e-mail of malplaatje gebruiken.
...
![&#x200B; Algemene instellingen thema](./assets/email-theme-general-settings.png){width="450"}
...
* Klik **[!UICONTROL Add variant]** om veelvoudige kleurenvarianten, zoals a _licht_ en _donkere_ wijze tot stand te brengen, waar elke variant zijn eigen kleurenpalet en nuancecontroles heeft.

  >[!NOTE]
  >
  >Voor elk merkthema kunt u maximaal vier varianten definiëren.
...
| [!UICONTROL Paragraphs] | ![&#x200B; de tekststijlen van de Paragraaf voor type P1 &#x200B;](./assets/email-theme-text-settings-paragraphs.png){width="300"} | Selecteer **[!UICONTROL P1]** , **[!UICONTROL P2]** , enzovoort voor het alineatype dat u wilt instellen. Stel de **[!UICONTROL Font library]** in op _[!UICONTROL Standard]_&#x200B;of&#x200B;_[!UICONTROL Google Fonts]_ . Kies vervolgens de lettertypefamilie, -grootte en -stijl. Pas de **[!UICONTROL Line height]** naar wens aan. Kies **[!UICONTROL Text alignment]**: _Linker_, _Gecentreerd_, _Juist_, of _Uitgelijnd_. |
...
| Type | Instellingen | Beschrijving |
| ---- | -------- | ----------- |
| [!UICONTROL Line] | ![&#x200B; de lijnmontages van de Scheidingslijn &#x200B;](./assets/email-theme-divider-settings-line.png){width="300"} | Plaats **[!UICONTROL Border style]** door een waarde van de lijst van standaardCSS `border-style` waarden, zoals _Ononderbroken_ te kiezen, _Gestippeld_, en _Gebroken_. |
...
Wanneer u van het thema de plaats bepaalt, klik _Meer menu_ (**...**) aan de rechterbenedenhoek van de themakaart en kies de actie die u wilt uitvoeren:
