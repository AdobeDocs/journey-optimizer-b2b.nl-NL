...
description: 'Bewerk afbeeldingen op een native manier met Adobe Express in Journey Optimizer B2B edition: resize, crop, remove background, converteer indelingen en sla ze op in de gegevensopslagruimte.'
...
Adobe Journey Optimizer B2B edition kan op een native manier worden geïntegreerd met Adobe Express en biedt toegang tot een set Adobe Express-gereedschappen voor het bewerken van afbeeldingen. Met deze gereedschappen kunt u de afbeeldingen wijzigen die zijn opgeslagen in de Journey Optimizer B2B edition-gegevensopslagruimte. De integratie biedt de volgende belangrijke voordelen:
...
1. Zoek de afbeelding die u wilt wijzigen of gebruik als origineel om een nieuw element te maken.
   ...
   * Als u naar een afbeeldingselement in de geselecteerde map wilt zoeken, voert u een tekstreeks in de zoekbalk in.
   ...
   ![ doorbladert activa in de bewaarplaats van Journey Optimizer B2B edition ](./assets/assets-native-workspace-filtered.png){width="800" zoomable="yes"}

1. Klik op de naam van het afbeeldingselement om het te openen en de details ervan weer te geven.

   >[!TIP]
   >
   >Het is beste praktijken om [ het _[!UICONTROL Used By]_lusje ](./internal-image-assets.md#view-asset-used-by-references) in de beelddetails te selecteren en de inhoud te herzien waar het beeld momenteel wordt gebruikt alvorens u te werk gaat om aan het beelddossier uit te geven.
