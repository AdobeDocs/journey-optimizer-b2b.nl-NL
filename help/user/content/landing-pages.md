...
Als u uw klanten naar een gedefinieerde webpagina wilt sturen wanneer ze op een specifieke koppeling klikken, maakt u een bestemmingspagina in Journey Optimizer B2B edition:
...
### Een opgeslagen sjabloon of voorbeeldsjabloon selecteren

U kunt kiezen uit:

* **malplaatjes van de Steekproef**. De Journey Optimizer B2B edition-interface biedt een verzameling out-of-the-box landingspagina-sjablonen die u kunt gebruiken als beginpunt voor het ontwerp van uw bestemmingspagina.
