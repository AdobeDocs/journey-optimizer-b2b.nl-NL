...
>abstract="Schakel over naar de donkere modus waar u een voorvertoning kunt weergeven van de rendermethode en specifieke aangepaste instellingen kunt definiëren. <br> het definitieve teruggeven hangt van de e-mailcliënt van de ontvanger af. Houd er rekening mee dat alle e-mailclients geen aangepaste donkere modus ondersteunen."
...
## Overwegingen voor e-mailclient {#email-client-considerations}
...
In dit geval hebben de instellingen voor de donkere modus van de client voorrang op de instellingen voor de aangepaste donkere modus die u in [!DNL Journey Optimizer B2B Edition] definieert.
...
* Gebruik de [ voorproeffunctie ](#preview-dark-mode) om het gebrek te herzien donkere wijze die voor de meeste steunende e-mailcliënten teruggeeft.

* Als u de standaardinstellingen voor het ondersteunen van e-mailclients wilt overschrijven, definieert en past u aangepaste instellingen voor de donkere modus toe op uw e-mailinhoud. [ Leer meer ](#custom-dark-mode)
...
1. Verander de selecteur in _Donkere wijze_ ( ![ Donker wijzepictogram ](../assets/do-not-localize/icon-content-dark-mode.svg) ).
   ...
   Op het canvas wordt de inhoud weergegeven met behulp van de standaardvoorvertoning in de donkere modus.
...
1. Als u een Litmus Enterprise-account hebt, selecteert u **[!UICONTROL Render email]** om de uiteindelijke rendering in donkere modus weer te geven voor verschillende e-mailclients in de Litmus-integratie.
...
Aangezien de donkere wijzetoepassing over belangrijke e-mailcliënten stijgt, is het essentieel om te overwegen hoe uw e-mail in zowel lichte als donkere milieu&#39;s teruggeeft - of u [ douane donkere wijze ](#custom-dark-mode) of niet gebruikt.
