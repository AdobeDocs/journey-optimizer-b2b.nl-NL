...
Wijzig de tekst in het veld **[!UICONTROL Button text]** terwijl de tab _[!UICONTROL Content]_&#x200B;in het rechterdeelvenster wordt weergegeven. De knopgrootte wordt aangepast aan de lengte van de tekst.
...
_om aangepaste CSS voor de vorm te bepalen:_
