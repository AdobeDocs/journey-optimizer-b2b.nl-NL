...
Wijzig de tekst in het veld **[!UICONTROL Button text]** terwijl de tab _[!UICONTROL Content]_in het rechterdeelvenster wordt weergegeven. De knopgrootte wordt aangepast aan de lengte van de tekst.
