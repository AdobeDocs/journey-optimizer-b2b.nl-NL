...
![&#128279;](../assets/do-not-localize/toolbar-structure.png){width="150"} de componententoolbar van 0&rbrace; Structuur
...
In de visuele ontwerpruimte hebt u toegang tot de structurele componenten, inclusief kolommen en inhoud, met behulp van de navigatiestructuur. Klik het _[!UICONTROL Navigation tree]_&#x200B;pictogram ( ![&#x200B; de boompictogram van de Navigatie &#x200B;](../assets/do-not-localize/icon-navigation-tree.svg)) op de linkerzijde om de boom te tonen.

![&#x200B; heb toegang tot de inhoudslagen &#x200B;](../../assets/content-design-shared/content-design-layers.png){width="800" zoomable="yes"}

Het element _[!UICONTROL Body]_&#x200B;is de basis van de boomstructuur. Klik op een van de componenten of onderliggende kolomelementen in de structuur om deze op het canvas te selecteren. De tabbladen&#x200B;_[!UICONTROL Settings]_ en _[!UICONTROL Styles]_&#x200B;rechts geven de parameters voor die component of kolom weer.
