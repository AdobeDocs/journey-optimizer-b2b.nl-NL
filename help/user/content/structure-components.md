...
![ belemmering een structuur op het canvas ](../../assets/content-design-shared/content-design-add-structure.png){width="800" zoomable="yes"}
...
](../assets/do-not-localize/toolbar-structure.png){width="150"} de componententoolbar van 0} Structuur![
...
Nadat u een component hebt toegevoegd, wordt deze geselecteerd in de ruimte van het visuele ontwerp en worden de eigenschappen ervan weergegeven in het rechterdeelvenster. Het tabblad _[!UICONTROL Settings]_wordt standaard weergegeven. U kunt ook op elk gewenst moment een structuurcomponent selecteren om de instellingen te wijzigen.
...
![ Kolommen niet stapelen op mobiele apparaten ](./assets/structure-component-settings-stack-columns.png){width="250"}
...
Selecteer het tabblad _[!UICONTROL Styles]_in het rechterdeelvenster en gebruik de sectie **[!UICONTROL Background]**om de kleur en optionele afbeelding te definiëren die u als achtergrond voor de structuurcomponent wilt gebruiken.
...
Kies het [ type van middelbron 0} ](./assets-overview.md) en selecteer het beelddossier:
...
Gebruik _selecteer een kolom_ hulpmiddel in de componententoolbar om een kolom te selecteren. Vervolgens kunt u de kolomwerkbalk gebruiken om de kolomselectie te wijzigen, de kolom te verwijderen of om variaties in de voorwaardelijke inhoud toe te passen voor de kolom. De parameters voor de kolom worden weergegeven op de tabbladen _[!UICONTROL Settings]_en_[!UICONTROL Styles]_ rechts.
...
| ![ selecteer een kolom ](../assets/do-not-localize/toolbar-button-column-select.png){width="100"} | Een kolom selecteren | Selecteer een kolom op nummer. Als de kolom is geselecteerd, kunt u instellingen en stijlen toepassen. |

### Kolommen n :n wijzigen

De kolombreedten zijn statisch voor de meeste structuurcomponenten. Als u de component _[!UICONTROL n:ncolumn]_ toevoegt, kunt u het aantal kolommen en de grootte van de kolommen wijzigen. De n :n kolomcomponent begint met vijf kolommen van gelijke breedte (20%).
...
Selecteer de component in het canvas en gebruik de optie **[!UICONTROL Columns number]** in het rechterdeelvenster om het aantal kolommen te wijzigen. Klik op de pictogrammen pijl-omhoog en pijl-omlaag om het aantal kolommen te vergroten of te verkleinen, of voer het getal in het veld in.

![ het aantal plaatsen van Kolommen ](./assets/structure-components-n-n-columns-number.png){width="650" zoomable="yes"}

Verplaats op het canvas het pictogram voor kolomgrootte om de breedte van de geselecteerde kolom aan te passen. Als u de breedte vergroot of verkleint, wordt de aangrenzende kolom ook zodanig aangepast dat alle kolommen 100% van de componentbreedte bezetten.
...
* **[!UICONTROL Background color]** - Selecteer het selectievakje en klik op het kleurvakje om een kleur te kiezen in de kiezer. U kunt een kleur kiezen door een bekende RGB-, HSL-, HSB- of hexadecimale waarde in te voeren. U kunt ook de kleurschuifregelaar en het kleurveld gebruiken om de kleur te selecteren.

  ![ de kiezer van de Achtergrondkleur ](../../assets/content-design-shared/content-components-styles-background-color.png){width="300"}

* **[!UICONTROL Background image]** - Verplaats de schakelknop om de achtergrondafbeeldingsinstellingen in te schakelen.

  ![ de montages van het Achtergrondbeeld ](./assets/structure-components-background-image-settings.png){width="250"}

  Kies het type van activabron en [ selecteer een beelddossier ](#background-image).
...
In de visuele ontwerpruimte hebt u toegang tot de structurele componenten, inclusief kolommen en inhoud, met behulp van de navigatiestructuur. Klik het _[!UICONTROL Navigation tree]_pictogram ( ![ de boompictogram van de Navigatie ](../assets/do-not-localize/icon-navigation-tree.svg)) op de linkerzijde om de boom te tonen.

![ heb toegang tot de inhoudslagen ](../../assets/content-design-shared/content-design-layers.png){width="800" zoomable="yes"}

Het element _[!UICONTROL Body]_is de basis van de boomstructuur. Klik op een van de componenten of onderliggende kolomelementen in de structuur om deze op het canvas te selecteren. De tabbladen_[!UICONTROL Settings]_ en _[!UICONTROL Styles]_rechts geven de parameters voor die component of kolom weer.
