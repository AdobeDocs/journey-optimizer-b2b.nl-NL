...
>[!IMPORTANT]
>
>Wanneer de rekeningsreis in een andere reis van a _wordt gebruikt neem een actie_ knoop met de _[!UICONTROL Add Account to (other) Journey]_&#x200B;actie, die de wegblokkades aborteert die actie in die reis.
...
>[!IMPORTANT]
>
>Wanneer de rekeningsreis in een andere reis van a _wordt gebruikt neem een actie_ knoop met de _[!UICONTROL Add Account to (other) Journey]_&#x200B;actie, die het sluit aan nieuwe ingangen blokkeert die actie van die reis.
