...
_(Alleen voor reizen naar accounts)_
...
| --------------- | ----------- |
| [!UICONTROL Account Attributes] | Attributen van het accountprofiel, waaronder: <li>Jaarlijkse ontvangsten <li>Stad <li>Land <li>Werknemersgrootte <li>Marktsegment <li>Naam <li>SIC-code <li>Staat |
| [!UICONTROL Account Attributes] > Heeft `<custom object>` | [!BADGE &#x200B; Beta &#x200B;]{type=Informative tooltip="Beta-functie"} de rekening heeft of geen relationele schemaverslagen. Het kan ook tegen om het even welke geselecteerde die criteria van douaneobjecten worden geëvalueerd, zoals in het [&#x200B; wordt gevormd relationele schema XDM &#x200B;](../admin/xdm-field-management.md#relational-schemas). (Zie [&#x200B; Gegevens die &#x200B;](#custom-data-filtering) filtreren van de Douane.) |
...
_(Account en Persoonlijke reizen)_
...
| [!UICONTROL Person attributes] | Attributen van het [&#x200B; persoonprofiel &#x200B;](../admin/field-mapping.md#xdm-business-person-attributes), die omvatten: <li>Stad <li>Land <li>E-mailadres <li>E-mail is ongeldig <li>E-mail is geschorst <li>Voornaam <li>Overgenomen deelstaatgebied <li>Functie <li>Achternaam <li>Mobiel telefoonnummer <li>Persoonlijke betrokkenheidsscore <li>Telefoonnummer <li>Postcode <li>Staat |
| [!UICONTROL Person Attributes] > Heeft `<custom object>` | [!BADGE &#x200B; Beta &#x200B;]{type=Informative tooltip="Beta-functie"} de persoon heeft of geen relationele schemaverslagen. Het kan ook tegen om het even welke geselecteerde die criteria van douaneobjecten worden geëvalueerd, zoals in het [&#x200B; wordt gevormd relationele schema XDM &#x200B;](../admin/xdm-field-management.md#relational-schemas). (Zie [&#x200B; Gegevens van de Douane het filtreren &#x200B;](#custom-data-filtering)) |
| [!UICONTROL Special filters] > [!UICONTROL Member of Buying Group] | (Verouderd) De persoon is al dan niet een lid van de koopgroep dat wordt beoordeeld aan de hand van een of meer van de volgende criteria: <li>Belang van oplossing</li><li>Status van kopersgroep</li><li>Complete score</li><li>Engagement Score</li><li>Is verwijderd</li><li>Functie</li> |
| [!UICONTROL Special filters] > [!UICONTROL Member of List] | (Verouderd) De persoon is al dan niet lid van een of meer [!DNL Marketo Engage] -lijsten. |
| [!UICONTROL Special filters] > [!UICONTROL Member of Program] | (Verouderd) De persoon is al dan niet lid van een of meer [!DNL Marketo Engage] -programma&#39;s. |
...
1. (Alleen voor reizen naar account) Stel de **[!UICONTROL Attributes used for conditions]** in.
...
![&#x200B; Pad splitsen op voorwaarde voor [!DNL Marketo Engage] lijstlidmaatschap](./assets/node-split-paths-conditions-people-member-of-list.png){width="700" zoomable="yes"}
<br/>
...
>
>Met de [&#x200B; vereenvoudigde architectuur &#x200B;](../simplified-architecture.md) voor Journey Optimizer B2B edition, wordt het filtreren gebaseerd op lijst of programmalidmaatschap in een instantie van Marketo Engage niet gesteund.

>[!ENDSHADEBOX]

## Aangepaste gegevensfiltering

[!BADGE &#x200B; Beta &#x200B;]{type=Informative tooltip="Beta-functie"}

U kunt relationele schema&#39;s (op model-gebaseerde klassen) gebruiken om wegen door rekening of mensen te verdelen. De douanevoorwerpen worden bepaald binnen _relationele schema&#39;s_, en een productbeheerder kan [&#x200B; relationele schemagebieden &#x200B;](../admin/xdm-field-management.md#relational-schemas) in [!DNL Journey Optimizer B2B Edition] vormen. De geselecteerde schemagebieden zijn beschikbaar in de voorwaardenredacteur voor gebruik in _gespleten weg door rekening_ en _gespleten weg door mensen_ knopen.

Voor een voorwaarde **[!UICONTROL Split path by account]** gebruikt u het zoekveld om de lijst te filteren op de naam van het aangepaste object onder _[!UICONTROL Account Attributes]_. Voeg de voorwaarde toe en stel de waarde in op `true` of `false` .

![&#x200B; de attributenvoorwaarden van de Persoon voorbeeld voor relationeel schema douanevoorwerp &#x200B;](./assets/node-split-paths-account-relational-schema.png){width="600" zoomable="yes"}

Voor een voorwaarde **[!UICONTROL Split path by people]** gebruikt u het zoekveld om de lijst te filteren op de naam van het aangepaste object onder _[!UICONTROL Person Attributes]_.

![&#x200B; de attributenvoorwaarden van de Persoon voorbeeld voor relationeel schema douanevoorwerp &#x200B;](./assets/node-split-paths-people-relational-schema.png){width="600" zoomable="yes"}
...
Voeg de wegen van de a _Fusie_ knoop toe om verschillende _gespleten wegen door rekening_ in uw reis te combineren.
