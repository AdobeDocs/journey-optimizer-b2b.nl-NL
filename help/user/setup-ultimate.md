...
description: Stel Journey Optimizer B2B Edition in. Configureer XDM-schema's, e-mail-/sms-kanalen, Marketo Engage-reishandelingen en gebruikers.
...
Adobe Journey Optimizer B2B Edition is gebouwd op Adobe Experience Platform. Met deze implementatie bevinden Journey Optimizer B2B Edition en Marketo Engage zich niet op hetzelfde systeem en dezelfde gegevensopslag. Journey Optimizer B2B Edition ontvangt gegevens van Adobe Experience Platform. De toepassing blijft echter afhankelijk van Marketo Engage-rechten en bepaalde back-endfuncties, zoals e-maillevering, voor de levering en configuratie van het systeem.
...
Deze implementatie is de basis die mogelijkheden in Journey Optimizer B2B Edition ontgrendelt:

* **verenigt en schalen gemakkelijk uw gegevens:** het platform steunt complexe gegevensmodellen, met inbegrip van douanevoorwerpen, het kopen groepen, en rekeningsgebeurtenissen.
...
* **houd uw gegevens veilig:** Geavanceerde privacy en veiligheidseigenschappen die helpen uw klanteninformatie beschermen. (_Binnenkort_)

* **Gebouwd voor de toekomst:** Deze opstelling steunt aan de gang zijnde verbeteringen en innovatie.

Gebruik de volgende richtlijnen voor configuratie.

Gebruik deze controlelijst om de installatie van Journey Optimizer B2B Edition te voltooien.
...
Als u e-mailberichten wilt verzenden vanuit [!DNL Journey Optimizer B2B Edition] , configureert u de e-mailtracering en de te leveren items in de bijgevoegde [!DNL Marketo Engage] -productieinstantie en in de [!DNL Journey Optimizer B2B Edition] -app.
