...
1. Schakel de schuifregelaar in of uit.
   ...
   Voor _[!UICONTROL Match with Proximity Pattern]_kunt u ook de hoeveelheid seconden voor **[!UICONTROL Duration Between Activities]**instellen (de standaardwaarde is `0` , het maximum is `3` ).
