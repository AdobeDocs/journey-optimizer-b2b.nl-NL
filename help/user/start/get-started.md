...
description: 'Handleiding on boarding voor beheerders en marketers: stel sandboxen in, configureer kanalen, maak inkoopgroepen en ontwerp accountreizen in Journey Optimizer B2B edition.'
role: User
level: Beginner
...
# Richtlijnen voor het aan boord nemen van gebruikers
...
Nadat een beheerder de [ opstellingstaken ](../setup-ultimate.md) voltooit, gebruik deze informatie voor algemene gebruiker op het instappen.
...
1. **creeer het kopen groepen**. Definieer de belangrijkste componenten voor het bereiken van uw bedrijfsdoelstellingen en -doelstellingen en maak inkoopgroepen die de leden voor uw doelaccountlijsten identificeren. [ Leer meer ](../buying-groups/buying-groups-overview.md)
...
1. **voeg gepersonaliseerde en dynamische e-mailmalplaatjes** toe. Gebruik Journey Optimizer B2B Edition-personalisatie en dynamische inhoudmogelijkheden om uw boodschap aan te passen aan uw publiek. [ Leer meer ](../content/email-templates.md)
