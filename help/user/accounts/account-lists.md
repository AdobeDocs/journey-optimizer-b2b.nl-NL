...
description: Maak statische en dynamische accountlijsten met aangepaste filters voor doelgerichte reisorganisatie en accountmarketing in Journey Optimizer B2B edition.
...
>[!NOTE]
>
>Account geeft gegevens van een hefboomaccount van Marketo Engage weer om accountsegmenten en lijsten te maken. Dit betekent dat als een accountsegment van Adobe Experience Platform niet actief wordt gesynchroniseerd met Marketo Engage, de accounts in dat Experience Platform-segment mogelijk niet beschikbaar zijn in de accountlijsten van Journey Optimizer B2B edition. Vervolgens worden alleen personen van accounts in Experience Platform-segmenten die zijn gesynchroniseerd met Marketo Engage opgenomen in het aantal personen dat lid is van de organisatie en gebeurtenissen activeert.
