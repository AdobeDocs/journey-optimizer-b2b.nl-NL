...
+ Aan de slag {#get-started}
   ...
   + [Gebruiker aan boord](./start/get-started.md)
...
+ Accounts {#accounts}
   + Koopgroepen {#buying-groups}
      ...
      + [Rol inzichten](./buying-groups/buying-group-role-insights.md)
      + Score voor groepen kopen {#scoring}
         + [Betrokkenheidsscores](./buying-groups/engagement-scores.md)
         + [Volledigheidsscores](./buying-groups/completeness-scores.md)
...
+ Inhoudsbeheer {#content-management}
   ...
   + Assets {#assets}
      ...
      + Interne activa {#internal-dam}
         + [Werken met interne middelen](./content/internal-image-assets.md)
...
+ Administratie {#admin}
   ...
   + Configuraties {#configurations}
      ...
      + [Externe acties](./admin/configure-external-actions.md)
   + Kanalen {#channels}
