...
U kunt een taak van een inkoopgroep verwijderen door op de ellips (...) te klikken naast de taaknaam en kies **[!UICONTROL Delete]** .
...
1. Schakel de instelling **[!UICONTROL Update existing buying groups]** (optioneel) in.
   ...
   Als deze optie is ingeschakeld, worden alle bestaande inkoopgroepen die aan de interesse van de oplossing zijn gekoppeld, bijgewerkt via de dagelijkse synchronisatiecyclus.
...
1. Gebruik op het tabblad _[!UICONTROL Solution interest]_&#x200B;een van de volgende methoden om de eigenschappen te openen voor de interesse van de oplossing die u wilt bewerken:
   ...
   * Klik op de ellips (**...**) en kies **[!UICONTROL Edit]** .
...
1. Van het _[!UICONTROL Solution interest]_&#x200B;lusje, klik de ellips (**...**) naast de interesse van de oplossing en kies **[!UICONTROL Delete]**.
