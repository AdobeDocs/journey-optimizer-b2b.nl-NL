...
Op een B2B-markt worden aankoopbeslissingen meestal door meerdere personen genomen. Deze personen nemen deel aan het besluitvormingsproces overeenkomstig hun rol binnen de organisatie. Creeer het kopen rolmalplaatjes van de groep die een groep roldefinities volgens elk product bevatten die type of rekeningsgeval aanbieden.
...
| [!UICONTROL Custom Objects] > Heeft `<custom object>` | [!BADGE &#x200B; Beta &#x200B;]{type=Informative tooltip="Beta-functie"} de rekening heeft of geen relationele schemaverslagen. Het kan ook tegen om het even welke geselecteerde die criteria van douaneobjecten worden geëvalueerd, zoals in [&#x200B; wordt gevormd XDM relationele schema&#39;s &#x200B;](../admin/xdm-field-management.md#relational-schemas). |
| Speciale filters | <li>Lid van de lijst (afgekeurd) <li>Lid van het programma (afgekeurd) |
| Intentgegevens | <li>Categorie-intentie <li>Productintentie <li>De intentie van het sleutelwoord <br/> (zie [_Gegevens van de Intentie_](../admin/intent-data.md)) |

1. Voor de eerste rolkaart, bepaal de roleigenschappen.

   * Kies de **[!UICONTROL Buying group role]** in de lijst.

     Er zijn zes standaardrollen: `Decision Maker`, `Influencer`, `Practitioner`, `Executive Steering Committee`, `Champion` en `Other` . De lijst omvat ook om het even welke [&#x200B; douanerollen die in de _2&rbrace; lijst van Rollen &#x200B;](./default-custom-roles.md#custom-roles) worden bepaald._
...
1. Klik op **[!UICONTROL Add Condition]** en definieer de voorwaardelijke regel voor de rol.
   ...
   * Vouw in het dialoogvenster _[!UICONTROL Condition]_&#x200B;de lijst met **[!UICONTROL Person attributes]**&#x200B;uit en zoek een kenmerk dat u wilt gebruiken om de rol aan te passen. Sleep het naar rechts en zet het neer in de filterruimte.
     ...
     >[!NOTE]
     >
     >Als u de gebieden van de douanepersoon in het bedrijfspersoonschema in Experience Platform wordt bepaald, zijn deze gebieden ook beschikbaar om als persoonattributen in voorwaarden te gebruiken.
   ...
   * Als er gevormde douanevoorwerpen met betrekking tot mensen [&#x200B; worden bepaald in de Relationele schema&#39;s XDM &#x200B;](../admin/xdm-field-management.md#relational-schemas), breid de lijst van **[!UICONTROL Custom Objects]** uit om hen in de rolvoorwaarde te gebruiken.

     ![&#x200B; het malplaatje van Rollen voegt de voorwaarde van het douanevoorwerp toe &#x200B;](assets/roles-template-role-condition-custom-object.png){width="700" zoomable="yes"}

   * Voeg zo nodig een ander kenmerk/object en een andere voorwaarde toe die de criteria voor een overeenkomst met de rol verder verfijnen.
