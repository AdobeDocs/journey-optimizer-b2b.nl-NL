...
1. Voor de eerste rolkaart, bepaal de roleigenschappen.
   ...
   * Kies de **[!UICONTROL Buying group role]** in de lijst.
     ...
     Er zijn zes standaardrollen: `Decision Maker`, `Influencer`, `Practitioner`, `Executive Steering Committee`, `Champion` en `Other` . De lijst omvat ook om het even welke [ douanerollen die in de _2} lijst van Rollen ](./default-custom-roles.md#custom-roles) worden bepaald._
