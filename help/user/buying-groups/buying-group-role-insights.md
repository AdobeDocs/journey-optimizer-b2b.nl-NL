...
description: Meer informatie over het rollendashboard dat het aanschaffen van rollen en het aantrekken van betrokkenheid bij inkoopgroepen in Journey Optimizer B2B edition bijhoudt.
...
# Het dashboard met rolinzichten

Het rollendashboard geeft inzicht in hoe het aanschaffen van groepsrollen zich ontwikkelt en zich in de loop der tijd aansluit. Het helpt marketers trends op het gebied van rolverwerving, betrokkenheidspatronen en hoe recente campagnes betrokkenheid tussen verschillende rollen binnen inkoopgroepen stimuleren.
...
| ---- | ----------- |
| [!UICONTROL Role acquisition over time] | Visualiseert het aantal leden dat in de loop der tijd aan inkoopgroepen is toegevoegd, dat per rol wordt gesegmenteerd en per maand wordt gegroepeerd. |
| [!UICONTROL Engagement by role] | Hiermee geeft u het totale aantal betrokkenheidsactiviteiten weer (zoals het openen van e-mail, klikken en inzendingen van formulieren) door de rol van de inkoopgroep te kiezen. |
| [!UICONTROL Engagement by role over time] | Tracks die groepsbetrokkenheidsactiviteiten in de loop der tijd kopen, die maandelijkse betrokkenheidstrends per rol weergeven. |
