...
1. Klik op **[!UICONTROL Save]** als u tevreden bent met de stappen die u hebt gedefinieerd.
   ...
   >[!IMPORTANT]
   >
   >**nadat de het kopen groepsstadia worden bewaard, kunnen zij niet worden verwijderd.** Nochtans, kunt u de naam en de beschrijving voor om het even welke stadia veranderen zolang het model in _status van het Ontwerp 0&rbrace; &lbrace;blijft._
