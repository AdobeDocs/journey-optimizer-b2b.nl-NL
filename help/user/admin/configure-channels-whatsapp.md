...
1. Kies `WhatsApp` bij **[!UICONTROL Select channel]** .
   ...
   Alle toestemmingsbeleid verbonden aan een geselecteerde marketing actie wordt automatisch leveraged om de voorkeur van uw klanten te respecteren. Bijvoorbeeld, wordt om het even welk bericht WhatsApp die die configuratie in een reis gebruiken slechts verzonden naar de profielen die toestemming hebben gegeven om berichten WhatsApp van u te ontvangen. Profielen die niet hebben ingestemd met het ontvangen van deze communicatie worden uitgesloten.
