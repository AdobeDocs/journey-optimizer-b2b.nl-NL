...
Voor informatie over hoe de geselecteerde gebieden voor geavanceerde e-mailverpersoonlijking worden gebruikt, zie [&#x200B; verpersoonlijking van de Inhoud &#x200B;](../content/personalization.md#custom-datasets).
