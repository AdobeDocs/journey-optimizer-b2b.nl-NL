---
title: Gebruikerstoegang en -machtigingen
...
# Toegang en machtigingen van gebruikers
...
1. Ga een naam van het productprofiel, zoals _B2B Gebruikers_ in.

1. Klik op **[!UICONTROL Next]** en vervolgens op **[!UICONTROL Save]** .

## Een gebruikersgroep toevoegen voor het profiel {#add-user-group}

Een gebruikersgroep is een inzameling van gebruikers die een gedeelde reeks toestemmingen worden verleend. U kunt gebruikers toevoegen aan of verwijderen uit uw gebruikersgroep. De machtigingen voor de groep blijven ongewijzigd wanneer de gebruikers in de groep worden gewijzigd.

>[!TIP]
>
>Als u naar de vereenvoudigde architectuur migreert en uw bestaande Journey Optimizer B2B edition-gebruikers aan Marketo Engage wilt toevoegen, kunt u de stappen voor het maken van gebruikersgroepen overslaan en gewoon de bestaande gebruikersgroep openen en het Marketo Engage-productprofiel toevoegen.
...
1. Ga een naam voor de gebruikersgroep, zoals _B2B Gebruikers_ in en klik **[!UICONTROL Save]**.
...
1. Klik **+** en voeg elke instantie van de volgende producten toe:
   ...
   * [!UICONTROL Adobe Experience Platform - Default Production All Access]
   ...
   ![ Admin Console - gebruiker-groep - voeg producten ](./assets/admin-console-user-group-add-products.png){width="550" zoomable="yes"} toe

1. Klik op **[!UICONTROL Save]** .

## Gebruikers aan een nieuwe groep toevoegen {#add-users}

Voor informatie over gebruikersbeheer, zie [_gebruikers van Adobe Admin Console_ ](https://helpx.adobe.com/enterprise/using/users.html){target="_blank"} in de documentatie van Admin Console.
...
1. Voeg elke gebruiker toe:
   ...
   * Voer het e-mailadres, de voornaam en de achternaam van de gebruiker in.
     ...
     ![ Experience Platform - voeg gebruikersprofiel voor de nieuwe rol ](./assets/admin-console-add-users.png){width="600" zoomable="yes"} toe
...
## Rollen bewerken voor productmachtigingen {#edit-roles-for-product-permissions}
...
Voor meer informatie over roltoestemmingen in Experience Platform, zie [ toestemmingen voor een rol ](https://experienceleague.adobe.com/en/docs/experience-platform/access-control/abac/permissions-ui/permissions){target="_blank"} in de documentatie van Experience Platform beheren.

### B2B-productmachtigingen {#b2b-product-permissions}
...
| B2B-reizen | Machtigingen voor B2B-reizen configureren, beheren, weergeven en publiceren. Deze machtigingen omvatten account- en persoonlijke handelingen, gebeurtenislisteners en gesplitste paden. | <li>B2B-reizen beheren |
| Journey Optimizer-regels | Toegang tot en vorm frequentieregels (communicatie grenzen). Deze machtigingen moeten beperkt zijn tot productbeheerders. | <li>Regels voor frequentie weergeven <li>Regels voor frequentie beheren |
...
1. Klik op **[!UICONTROL Add Groups]** .
   ...
   ![ Experience Platform - voeg groepen aan de rol toe ](./assets/aep-permissions-role-add-groups.png){width="700" zoomable="yes"}
...
1. Klik op **[!UICONTROL Save]** als u alle groepen hebt geselecteerd die u wilt toevoegen.
