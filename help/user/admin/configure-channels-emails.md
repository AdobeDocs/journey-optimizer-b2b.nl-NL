...
Ga naar **[!UICONTROL Administration]** > **[!UICONTROL Channels]** om de regels voor de communicatielimiet te bekijken of in te stellen. Selecteer onder _[!UICONTROL Email]_in het navigatievenster de optie **[!UICONTROL Communication limits]**.
