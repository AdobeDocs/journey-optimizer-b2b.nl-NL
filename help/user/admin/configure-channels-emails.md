...
>[!AVAILABILITY]
>
>Neem contact op met Adobe Support of open een ondersteuningsticket om het delen van communicatielimieten tussen Journey Optimizer B2B edition en een of meer Marketo Engage-exemplaren mogelijk te maken.

>[!BEGINSHADEBOX]

![&#x200B; het pictogram van Toestemmingen van AEP &#x200B;](../../assets/do-not-localize/icon_permissions-outline.svg) Deze stappen vereisen de volgende [&#x200B; toestemmingen voor uw toegewezen gebruikersrol in Experience Platform &#x200B;](../admin/user-management.md#b2b-product-permissions):

* **[!UICONTROL B2B Channel Configurations]** - `Manage B2B Channels`
* **[!UICONTROL Journey Optimizer Rules]** - `View Frequency Rules` en `Manage Frequency Rules`
...
Ga naar **[!UICONTROL Administration]** > **[!UICONTROL Channels]** om de regels voor de communicatielimiet te bekijken of in te stellen. Selecteer onder _[!UICONTROL Email]_&#x200B;in het navigatievenster de optie **[!UICONTROL Communication limits]**.
