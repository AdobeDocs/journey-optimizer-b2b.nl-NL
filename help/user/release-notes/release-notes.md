...
| Nieuwe functie | Toevoegen aan lijst en verwijderen uit lijst voor bewegingspersoneel | Pas uw e-mailinhoud aan op basis van de gedrags- en profielkenmerken van de ontvanger, zowel voor de account als voor de lead. <a href="../journeys/journey-nodes.md#action-nodes">Meer informatie</a> |
