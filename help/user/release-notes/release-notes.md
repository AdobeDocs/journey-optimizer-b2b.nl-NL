...
| ---- | ---- | ----------- |
| Functie | XDM-velden/relationele schema&#39;s - ondersteuning voor persoonlijk aangepaste objecten | Beheerders kunnen nu aangepaste objecten selecteren die verwant zijn aan een persoon die een één-op-één relatie met een account gebruikt. Dit vermogen laat uw marketing organisatie toe om een rijkere mening van uw echte bedrijfsgegevens te vertegenwoordigen om, entiteiten voorbij het persoon of rekeningsniveau te richten te personaliseren en te melden. |
...
| Verbetering | Account en persoonlijke reizen - ondersteuning voor persoonlijke objecten | Gebruik de relationele gegevens die zijn gekoppeld aan accounts voor het filteren van personen binnen een account- of persoonlijke reis. |
| Verbetering | Aanpassing van inhoud - ondersteuning voor aangepaste persoonlijke objecten | Wanneer u inhoudpersonalisatie gebruikend de douanevoorwerpen bepaalt, kunt u tot variabelen voor de model-gebaseerde klasse douanevoorwerpen (relationele schema&#39;s) toegang hebben. |
