...
| Functie | WhatsApp-kanaal | Marketers kunnen WhatsApp-berichten nu rechtstreeks verzenden via accountreizen via de Meta Cloud-API. Deze functie maakt naadloze integratie van WhatsApp-berichten mogelijk om reisinhoudkanalen te ondersteunen. |
...
| ----- | ------ | ----------- |
| Journey Build Agent | Nieuw en bijgewerkt | De Journey Build Agent analyseert, ideeert en maakt reizen in real time samen, toelatend marketers om sneller te lanceren, overeenkomst te verbeteren, en hogere omzettingspercentages te drijven. [Meer informatie &#x200B;](../agents/journey-agent.md) |
...
| Type | Item | Beschrijving |
| ---- | ---- | ----------- |
| Functie | Naar bestemming activeren voor reizen | Gebruik nieuw _activeer aan doel_ actie van de bedrijfrekening om direct aan bedrijven, eerder dan individuen te activeren. (Beperkt tot LinkedIn-bedrijven voor deze release.) [Meer informatie &#x200B;](../journeys/action-nodes.md#activate-to-a-linkedin-destination) |
...
| Functie | Het dashboard met rolinzichten | Het nieuwe dashboard van _[!UICONTROL Role Insights]_&#x200B;biedt inzicht in hoe uw campagnes en reizen invloed hebben op het aanschaffen van groepsrollen en betrokkenheid. [Meer informatie &#x200B;](../buying-groups/buying-group-role-insights.md) |
...
| Verbetering | weging van betrokkenheidsscore - AEP-gebeurtenissen | De weging van de betrokkenheidsscore kan nu elke standaard of aangepaste Experience Platform-gebeurtenis bevatten en worden gewogen op basis van uw behoeften. [Meer informatie &#x200B;](../admin/engagement-score-weighting.md) |
...
| Type | Item | Beschrijving |
| ---- | ---- | ----------- |
| Functie | Samenwerking met e-mailinhoud | Marketing teams kunnen nu opmerkingen maken en samenwerken met andere Journey Optimizer B2B edition-gebruikers in de context van een e-mailprogramma. Ze kunnen teamleden een e-mailbericht sturen met de details van de opmerking. Melding is ook beschikbaar als pulsmelding. [Meer informatie &#x200B;](../content/email-collaboration-tools.md) |
...
| Functie | Configuratie van trefwoordtoewijzing intent | Beheerders kunnen nu een spreadsheet uploaden om een categorie voor het toewijzen van intentiegegevens te definiëren, zodat ze het model voor intentdetectie kunnen activeren en beheren. [Meer informatie &#x200B;](../admin/intent-data.md) |
...
| Functie | Gegevens van groep en account voor kopen | Bekijk inzichten op de koopgroep en account-niveau om meer context en historische gegevens te hebben wanneer u met een klant begint in gesprek te gaan.<p>De gegevens van de inkoopgroep omvatten alle gevonden intenties van de eerste partij. <a href="../buying-groups/buying-group-details.md">Meer informatie </a><p>Op de pagina met accountdetails wordt de sterke toename in de overeenkomst gemarkeerd, zodat marketers de verkoop kunnen waarschuwen over accounts die klaar zijn voor een aangepaste, op de verkoop gerichte service.  <a href="../accounts/account-details.md"> Leer meer </a> |
...
| Type | Item | Beschrijving |
| ---- | ---- | ----------- |
| Functie | Voorwaardelijke inhoud in e-mails | Pas uw e-mailinhoud aan op basis van het gedrag van de ontvanger en de profielkenmerken van zowel de account als de lead. <p>Terwijl u een e-mail voor uw accountreis in de visuele ontwerpruimte voor e-mail ontwerpt, gebruikt u voorwaardelijke regels om meerdere varianten voor een inhoudscomponent te definiëren. <a href="../content/conditional-content.md">Meer informatie </a> |
| Functie | _voeg aan Lijst_ toe en _verwijder uit lijst_ personenacties in reizen | Gebruik reishandelingen om mensen toe te voegen aan of te verwijderen uit een statische lijst in een verbonden Marketo Engage-instantie, gecoördineerd met uw accountreisorkest. <a href="../journeys/action-nodes.md">Meer informatie </a> |
