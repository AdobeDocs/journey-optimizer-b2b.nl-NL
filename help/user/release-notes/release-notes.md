...
| Functie | E-mailontwerp - Ondersteuning voor Firefly en aangepaste Generative AI-modellen | U kunt nu de integratie van standaard- en aangepaste Firefly-modellen inschakelen, samen met goedgekeurde externe beeldmodellen (zoals NanoBanana). Marketers kunnen het beste model voor elk geval van gebruik selecteren: standaard Firefly voor algemene behoeften, aangepaste Firefly voor het genereren van producten onder het merk of goedgekeurde modellen van derden voor gespecialiseerde of experimentele scenario&#39;s. |
| Verbetering | E-mailontwerp - validatie van inhoudskwaliteit | Naast de uitlijning van merken kunt u de algehele kwaliteit van de inhoud evalueren om mogelijke problemen met leesbaarheid, coherentie en doeltreffendheid (onafhankelijk van uw merkrichtlijnen) aan het licht te brengen. Deze geautomatiseerde controles helpen onduidelijk overseinen, inconsistente toon, of structurele hiaten identificeren. |
...
| Verbetering | (Beta) Aanpassing van inhoud - ondersteuning voor persoonlijke aangepaste objecten | [!BADGE &#x200B; Vereenvoudigde architectuur &#x200B;]{type=Informative tooltip="Beschikbaar met vereenvoudigde architectuur"} wanneer u inhoudsverpersoonlijking gebruikend de douanevoorwerpen bepaalt, kunt u tot variabelen voor de op model-gebaseerde voorwerpen van de klassendouane toegang hebben (relationele schema&#39;s). [Meer informatie](../content/personalization.md#custom-datasets) |
| Verbetering | Activeren naar bestemmingen - Herbruikbaar publiek | U kunt virtueel publiek in _nu hergebruiken activeert aan bestemmings_ reisacties binnen de zelfde reis en verwijdert rekeningen uit virtueel publiek. |
...
| Verbetering | De reis _wacht_ knoop - geavanceerde montages | [!BADGE &#x200B; Vereenvoudigde architectuur &#x200B;]{type=Informative tooltip="Beschikbaar voor vereenvoudigde architectuur"} voor a _wacht_ knoop in een reis, kunt u uitgangsdagen en tijden nu specificeren, en tijdstreken selecteren. Deze verbetering geeft u betere controle voor uw reis orchestration en campagnemarkttiming. [Meer informatie](../journeys/wait-nodes.md#advanced-wait-settings) |
