...
description: 'Ontdek de nieuwste functies, verbeteringen en bugfixes in Adobe Journey Optimizer B2B Edition: blijf op de hoogte van nieuwe mogelijkheden en productverbeteringen.'
role: User, Admin
...
| ---- | ---- | ----------- |
| Functie | Op modellen gebaseerde aangepaste schema&#39;s | Aangepaste schema&#39;s maken van op modellen gebaseerde klassen. |
| Functie | Activeren naar doel | Gebruik nieuw _activeer aan doel_ actie van de bedrijfrekening om direct aan bedrijven, eerder dan individuen te activeren. (Beperkt tot LinkedIn-ondernemingen voor deze release.) |
...
| Functie | Deduplicatie e-mailvermoeidheid | U kunt deduplicatie van e-mail nu inschakelen om ervoor te zorgen dat dezelfde e-mail niet meerdere keren naar hetzelfde adres wordt verzonden. Dubbele adressen worden geblokkeerd totdat de eerste record met dat e-mailadres de reis heeft voltooid. |
