...
| ---- | ---- | ----------- |
| Functie | Samenwerking met e-mailinhoud | U kunt nu opmerkingen maken over het samenwerken met Journey Optimizer B2B edition-gebruikers in de context van een e-mailprogramma. U kunt tags toewijzen aan uw teamleden, zodat deze een e-mailmelding ontvangen met de details van de opmerking. Melding is ook beschikbaar als pulsmelding. <!-- [Learn more](../admin/engagement-score-weighting.md) --> |
| Functie | Donkere modus voor e-mailontwerp | De e-mailontwerpruimte omvat nu de capaciteit om op _donkere wijze_ over te schakelen. In de donkere modus kunt u een voorvertoning van de e-mailinhoud weergeven en aangepaste instellingen definiëren die specifiek moeten worden weergegeven voor ontvangers die hun e-mails in de donkere modus weergeven. <!-- [Learn more](../content/email-dark-mode.md) --> |
| Verbetering | Reizen - Pad splitsen op aantal personen in rol | Gebruik een gesplitst pad op accountknooppunt om een account te kiezen met het aantal personen in een of meer aankoopgroeprollen. In het pad kunt u de gereedheid van de inkoopgroep beoordelen voor verkoopwaarschuwingen en andere betrokkenheid op basis van de roldiepte. <!-- [Learn more](../journeys/split-merge-paths-nodes.md#buying-group-filtering-for-accounts) --> |
| Verbetering | Reizen - Persfilters voor gebeurtenissen | Gebruik personencilfilters om naar gebeurtenissen met personen te luisteren. Deze filters omvatten de capaciteit om voor een specifieke rol voor een gematchte het kopen groep te richten. <!-- [Learn more](../journeys/listen-for-event-nodes.md#add-filters-to-the-people-event) --> |
...
>[!NOTE]
>
>De versieveranderingen beginnen plaatsing op 26 augustus 2025, met een gefaseerde uitrol van elke eigenschap. Releasedatums voor functies en verbeteringen kunnen worden gewijzigd.
