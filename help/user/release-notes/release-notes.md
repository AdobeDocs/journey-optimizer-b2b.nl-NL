...
| Functie | Reisreis | U kunt nu accounts/personen meerdere keren verzenden via een workflow. Herbetreding heeft betrekking op meerdere scenario&#39;s, zoals herbeoordeling van kwalificatiecriteria en herbruikbare boomwerkstromen. [Meer informatie](../journeys/journey-re-entry.md) |
...
| Verbetering | Account en persoonlijke reizen - ondersteuning voor persoonlijke objecten | (Beta) Gebruik de relationele gegevens die gekoppeld zijn aan accounts voor het filteren van personen binnen een account- of personenreis. [Meer informatie](../journeys/split-merge-paths-nodes.md#custom-data-filtering) |
| Verbetering | (Beta) Aanpassing van inhoud - ondersteuning voor persoonlijke aangepaste objecten | Wanneer u inhoudpersonalisatie gebruikend de douanevoorwerpen bepaalt, kunt u tot variabelen voor de model-gebaseerde klasse douanevoorwerpen (relationele schema&#39;s) toegang hebben. [Meer informatie](../content/personalization.md#custom-datasets) |
...
| Type | Item | Beschrijving |
| ---- | ---- | ----------- |
| Functie | Merkits | (Beta) Definieer een merk in Journey Optimizer B2B edition om de bron van de waarheid te bieden die uw creatieve team kan gebruiken wanneer ze visuele of geschreven inhoud maken. Wanneer deze richtlijnen worden samengesteld en de merkmiddelen worden gedeeld, kan elk teamlid of medewerker on-brand inhoud voor uw product tot stand brengen. |
| Functie | Merken voor het genereren van e-mailinhoud | U kunt richtlijnen voor uw merk definiëren en deze informatie gebruiken om e-mailinhoud te genereren. Met deze functie wordt e-mailinhoud uitgelijnd met uw merkspecifieke richtlijnen, stijlen en tint voor het schrijven van tekst. |
| Verbetering | De reis _wacht_ knoop - geavanceerde montages | Voor a _wacht_ knoop in een reis, kunt u uitgangsdagen en tijden nu specificeren, en tijdstreken selecteren. Deze verbetering geeft u betere controle voor uw reis orchestration en campagnemarkttiming. |
| Verbetering | Speciaal filter voor lid van kopersgroep - Is verwijderd | Het _[!UICONTROL Member of Buying Group]_&#x200B;speciale filter omvat nu_ wordt Verwijderd _beperking. Wanneer u deze beperking aan het filter toevoegt, kunt u verwijderde koopgroepsleden opnemen of hen uitsluiten. Deze wordt ook ondersteund in slimme Marketo Engage-lijsten, waar u deze nieuwe beperking kunt gebruiken in het filter&#x200B;_[!UICONTROL Member of Buying Group]_ . |
