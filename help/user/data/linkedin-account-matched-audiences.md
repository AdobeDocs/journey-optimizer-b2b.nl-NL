...
# Gekoppelde benaderingen voor account

[!DNL Journey Optimizer B2B Edition] biedt de capaciteit aan om toe:voegen-publiek LinkedIn door de Gelijke Publiek van de Rekening te produceren, en wordt ontworpen om u te helpen lege rollen in uw het kopen groepen vullen. Door een reeks het kopen groepsfilters te bepalen, kunt u een LinkedIn Gelijke Publiek aan doelvooruitzichten handhaven die uw het kopen groepsparameters aanpassen. U kunt een publiek van een rekeningsreis van a ook activeren _neemt een actieknooppunt_.
...
1. Met _neem een actie_ knoop die in het wegcanvas wordt geselecteerd, plaats **[!UICONTROL Action on accounts]** aan **[!UICONTROL Activate to destination]**.
   ...
   ![&#x200B; knoop van de Reis - neem een actie op rekeningen - activeer aan bestemming &#x200B;](./assets/node-activate-destination.png){width="550" zoomable="yes"}

1. Van de knoopeigenschappen op het recht, kies de bestemming.

   * Als er een of meer doelen zijn gemaakt, kunt u op **[!UICONTROL Select destination]** klikken om een bestaand doel te kiezen.

   * Als er geen bestaande doelen zijn of als u een nieuwe bestemming wilt maken, klikt u op **[!UICONTROL Set up destination]** .

     ![&#x200B; knoop van de Reis - neem een actie op rekeningen - activeer aan bestemming - opstellingsbestemming &#x200B;](./assets/node-activate-destination-set-up-destination.png){width="550" zoomable="yes"}

     Met deze actie opent u de cataloguspagina Doelen op een nieuw browsertabblad.
